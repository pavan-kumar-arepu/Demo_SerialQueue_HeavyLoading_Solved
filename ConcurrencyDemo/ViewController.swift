...
class ViewController: UIViewController
{
    ...
    @IBAction func didClickOnStart(sender: AnyObject)
    {
        ...
        let serialQueue = dispatch_queue_create("com.ppam.imageQueue", DISPATCH_QUEUE_SERIAL)
        
//        let serialQueue = dispatch_queue_create("com.ppam.imageQueue", DISPATCH_QUEUE_CONCURRENT)
